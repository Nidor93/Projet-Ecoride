...
$sql = "SELECT t.*, u.utilisateur_id as chauffeur_id, u.prenom, u.nom, u.sexe, u.photo_profil, u.telephone, v.modele, v.couleur, v.pref_animal, v.pref_fumeur, v.immatriculation, v.est_electrique, v.categorie, t.prix,
...
if (isset($_SESSION['utilisateur_id'])) {
    ...
    $frais_service = 2;
    $cout_total = $t['prix'] + $frais_service;
}
...
<div class="container my-5 flex-grow-1">
    ...
    <?php include('../components/details_components.php') ?>
                ...
                <div class="d-grid gap-2">
                    ...
                    <?php elseif ($credits_passager < $cout_total): ?>
                        <button class="btn btn-danger btn-lg fw-bold" disabled>Crédits insuffisants (<?php echo($cout_total) ?>€)</button>
                    <?php else: ?>
